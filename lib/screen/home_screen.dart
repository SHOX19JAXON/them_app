      ...
      body: SafeArea(
        child: FutureBuilder(
          ...
          builder: (context, data) {
              ...
              if (weatherMainModel != null) {
                return Column(
                  ...
                  children: [
                              ...
                              decoration: InputDecoration(
                                  ...
                                  disabledBorder: OutlineInputBorder(
                                      borderSide: BorderSide(
                                          color:
                                              AppColors.c_072832.withOpacity(.6)),
                                      borderRadius: BorderRadius.circular(12)),
                    ...
                    Text(weatherMainModel.dateTime.getParsedDate(),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color:
                            isDark ? Colors.black.withOpacity(0.8) : Colors.blue,
                      ),
                      child: Padding(
            ...
            return Center(child: Text('network'));
          },
        ),
      ),
    );
